...
export const messages = {
  ja: {
    ...
    wallet_desc:
      "EVMチェーン（Etherscan API）のアドレスまたはENS名をライブ取得（ネイティブ＋主要ERC-20＋内部送金）し、円換算します。",
    ...
    wallet_hint:
      "0xアドレスまたはENS名（例: vitalik.eth）を貼り付け、同期するチェーンを選んでください（Etherscan経由のEVMチェーン）。ENS解決はEthereumメインネットのみです。APIキーは不要です。1件終わってから次を追加できます。DeFiは自動ラベル付けします — Reviewで確認してください。",
    wallet_chains_label: "同期するチェーン",
    wallet_chains_popular: "よく使う",
    wallet_chains_more: "その他",
    wallet_chains_more_show: "その他を表示（{n}）",
    wallet_chains_more_hide: "その他を隠す",
    wallet_chains_all: "Etherscan全チェーン（{n}）",
    wallet_chains_selected: "{n}チェーン選択中",
    wallet_chains_required: "1つ以上のチェーンを選んでください。",
    wallet_linked_chains: "同期済み: {chains}",
  ...
  en: {
    ...
    wallet_desc:
      "Live read across EVM chains via Etherscan API: address or ENS (native + major ERC-20 + internal transfers) — priced to JPY.",
    ...
    wallet_hint:
      "Paste a 0x address or ENS name (e.g. vitalik.eth) and pick chains to sync (EVM via Etherscan). ENS resolves on Ethereum mainnet only. No API key needed. Add another after this sync completes. DeFi is auto-labeled when possible — check Review.",
    wallet_chains_label: "Chains to sync",
    wallet_chains_popular: "Popular",
    wallet_chains_more: "More",
    wallet_chains_more_show: "Show more ({n})",
    wallet_chains_more_hide: "Hide more",
    wallet_chains_all: "All Etherscan chains ({n})",
    wallet_chains_selected: "{n} chain(s) selected",
    wallet_chains_required: "Select at least one chain.",
    wallet_linked_chains: "Synced: {chains}",
